...
**Важно! **Спецсимволы из допетровской кириллицы не входят в стандартные диапазоны, так что их надо прописывать вручную. Это будет выглядеть так:

* **\[єѕіїѡѣѥѧѩѫѭѯѱѳѵѹꙋꙗ\]** - спецсимволы нижнего регистра
* **\[ЄЅІЇѠѢѤѦѨѪѬѮѰѲѴѸꙊꙖ \]** - спецсимволы верхнего регистра

Более короткая запись \(диапазон по юникодной таблице + несколько символов, не входящих в него\):

* **\[Ѡ-ѿєѕіїꙋꙗЄЅІЇꙊꙖ\] **- спецсимволы верхнего и нижнего регистра
