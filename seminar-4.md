...
![](/assets/import999.png)![](/assets/import22222.png)Проверить правильность \(валидность\) синтаксиса XML можно с помощью какого-нибудь онлайн-инструмента -- [например, вот этого](https://codebeautify.org/xmlvalidator).
...
### ![](/assets/Screenshot_1.png)![](/assets/Screenshot_2.png)Сравнение двух вариантов одного текста

Посмотреть т.н. "диффы" можно, установив плагин EasyDiff для Sublime или Compare для Notepad++, но проще всего воспользоваться каким-нибудь онлайн-сервисом -- [например, вот этим](https://www.diffchecker.com/).
