...
В [справке Google Диска](https://support.google.com/drive/answer/2494822?co=GENIE.Platform%3DDesktop&hl=ru) есть подробно описаны различные права доступа, способы их предоставления и т.п.
