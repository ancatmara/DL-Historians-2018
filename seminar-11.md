...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import5.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import6.png)

Исправив формулу, нажимаем Enter и смотрим на результат.

![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import7.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import8.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import9.png)
...
2. Поставим курсор в ячейку С17 и применим автосумму. Формула будет такая: =СУММ\(C7:C16\)
   [3](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/seminar-3.html#fn_3)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import10.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import11.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import12.png)

Если мы свернем сгруппированные данные по десятилетиям, нажав на минус, останутся только строки с подытогами.

![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import13.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import.png)
...
1. В ячейке F17 написать формулу деления =C17/E17, а затем применить ее к ячейкам F28 и F34. 
   ![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import20.png)
2. Получившийся результат -- десятичная дробь с одним знаком после запятой, но нам нужны проценты. Чтобы получить их, достаточно просто изменить формат ячейки. Мы увидим, что на самом деле результаты немного различаются, а то, что на предыдущем шаге во всех ячейках было 0,7, объясняется округлением. 
   ![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import21.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import22.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import23.png)

Давайте по втоой половине таблицы посчитаем среднее за 1914-1923, максимум за 1924-1933 и минимум за 1934-1938.

![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import24.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import25.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import27.png)
...
#### ![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import29.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import30.png)![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import31.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import32.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import33.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import34.png)

![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import35.png)

![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import36.png)
...
![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import37.png)

![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import38.png)

![](https://ancatmara.gitbooks.io/digital-literacy-for-sfl/content/assets/import39.png)
